...
model9 <- glm(pd~benzene_c+fsp+road+lden+age+sex+imd+occup+cci0+whr+nosmoking+drinkingM+sleeph+regular+dieth,family='gaussian', data1)
model10 <- glm(pd~benzene_iqr+fsp+road+lden+age+sex+imd+occup+cci0+whr+nosmoking+drinkingM+sleeph+regular+dieth,family='gaussian', data1)
